...
# Создаем спортивную команду, выбирая случайные фамилии
sports_team = random.sample(group1, 5) + random.sample(group2, 5)
...
print("Длина списка:", len(sports_team))
...
if surname in sorted_team:
    ...
    print(f"Он встречается {sorted_team.count(surname)} раз(a)")
else:
